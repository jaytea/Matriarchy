...
# matriarchy begin
			(faction_get_slot, reg0, ":alt_rule_faction", mtrch_slot_faction_patriarchy),
    ...
    ("dplmc_policy_management",0,mesh_load_window,[
      (ti_on_presentation_load,
       [
		...
		(faction_get_slot, ":patriarchy", "fac_player_supporters_faction", mtrch_slot_faction_patriarchy),#<- mtrch+ added

        # done
        (create_game_button_overlay, "$g_presentation_obj_14", "@Done"),#<- dplmc+ changed obj_10 to obj_12
        (position_set_x, pos1, 900),
        (position_set_y, pos1, 25),
        (overlay_set_position, "$g_presentation_obj_14", pos1),#<- dplmc_ changed obj_10 to obj_12
		...
		(create_slider_overlay, "$g_presentation_obj_sliders_6", -3, 3),#<-mtrch+ added
        (assign, reg1, 25),
        ...
        (create_text_overlay, "$g_presentation_obj_sliders_10", ":text"),
		##dplmc+ end incremented sliders by 1
		(store_add, ":text", "str_dplmc_neither_mercantilist_nor_laissez_faire", ":mercantilism"),
		(create_text_overlay, "$g_presentation_obj_sliders_11", ":text"),#<- dplmc+ added

		(store_add, ":text", "str_mtrch_egalitarian", ":patriarchy"),
		(create_text_overlay, "$g_presentation_obj_sliders_12", ":text"),#<- mtrch+ added
		...
		(create_text_overlay, "$g_presentation_obj_6", "@Social policy:"),#<-- mtrch+ added
		#dplmc+ start incremented obj by 1...
        (create_text_overlay, "$g_presentation_obj_7", "@High centralization reduces tax inefficiency for the king and raises it for vassals. This will interfere the relations between ruler and vassals."),
        (create_text_overlay, "$g_presentation_obj_8", "@High aristocracy will improve the relations between the king and his vassals who will be able to raise bigger armies but it will decreased trade."),
        (create_text_overlay, "$g_presentation_obj_9", "@High serfdom reduces tax inefficiency for the king and his vassals and vassals can maintain bigger armies but troops loose moral."),
        (create_text_overlay, "$g_presentation_obj_10", "@High troop quality increases the strength of troops but decreases army size."),
		#dplmc+ end incremented obj by 1
		(create_text_overlay, "$g_presentation_obj_11", "@Mercantilistic policies maximize exports while minimizing imports, and increase government regulation of industry."),#<-dplmc+ added
		#matrch+ incremented obj by 1
		(create_text_overlay, "$g_presentation_obj_12", "@Social policy governs how patriarchic our society is. It controls the ratio of female/male recruits and the gender of important people."),#<-mtrch+ added
		...
		(overlay_set_val, "$g_presentation_obj_sliders_6", ":patriarchy"),#<- mtrch+ added
        (position_set_x, pos1, 200),

		##SLIDERS
		#dplmc start+ pushed all items by 150, then dropped all items by 75, then decreased the spacing from 150 to 100
        (position_set_y, pos1, 615 ),#575),#750),
        (overlay_set_position, "$g_presentation_obj_sliders_1", pos1),
        (position_set_y, pos1, 515 ),#450),#600),
        (overlay_set_position, "$g_presentation_obj_sliders_2", pos1),
        (position_set_y, pos1, 415 ),#325),#450),
        (overlay_set_position, "$g_presentation_obj_sliders_3", pos1),
        (position_set_y, pos1, 315 ),#200),#300),
        (overlay_set_position, "$g_presentation_obj_sliders_4", pos1),
		#dplmc end+ end pushed all items by 150
        (position_set_y, pos1, 215 ),#75),#150), #<- dplmc+ added
        (overlay_set_position, "$g_presentation_obj_sliders_5", pos1),#<- dplmc+ added
        (position_set_y, pos1, 115 ),#75),#150), #<- mtrch+ added
        (overlay_set_position, "$g_presentation_obj_sliders_6", pos1),#<- mtrch+ added


		##HEADERS
        (position_set_x, pos1, 100),
		#dplmc+ start pushed all items by 150, then dropped all items by 75, then changed the spacing to 100
        (position_set_y, pos1, 650 ),#625),#800),
        (overlay_set_position, "$g_presentation_obj_1", pos1),
        (position_set_y, pos1, 550 ),#500),#650),
        (overlay_set_position, "$g_presentation_obj_2", pos1),
        (position_set_y, pos1, 450 ),#375),#500),
        (overlay_set_position, "$g_presentation_obj_3", pos1),
        (position_set_y, pos1, 350 ),#250),#350),
        (overlay_set_position, "$g_presentation_obj_4", pos1),
		#dplmc+ end pushed all items by 150
		(position_set_y, pos1, 250 ),#125),#200), #<- dplmc+ added
        (overlay_set_position, "$g_presentation_obj_5", pos1), #<- dplmc+ added
		(position_set_y, pos1, 150 ),#125),#200), #<- mtrch+ added
        (overlay_set_position, "$g_presentation_obj_6", pos1), #<- mtrch+ added
        ...
        (position_set_y, pos1, 590 ),#550),#700),
        (overlay_set_position, "$g_presentation_obj_7", pos1),
        (position_set_y, pos1, 490 ),#425),#550),
        (overlay_set_position, "$g_presentation_obj_8", pos1),
        (position_set_y, pos1, 390 ),#300),#400),
        (overlay_set_position, "$g_presentation_obj_9", pos1),
        (position_set_y, pos1, 290 ),#175),#250),
        (overlay_set_position, "$g_presentation_obj_10", pos1),
		#dplmc+ end pushed all items by 150, and incremented obj by 1
		(position_set_y, pos1, 190 ),#50),#100), #<- dplmc+ added
        (overlay_set_position, "$g_presentation_obj_11", pos1), #<- dplmc+ added
		(position_set_y, pos1, 90 ),#50),#100), #<- mtrch+ added
        (overlay_set_position, "$g_presentation_obj_12", pos1), #<- mtrch+ added
		...
		(overlay_set_size, "$g_presentation_obj_11", pos1),#<- dplmc+ added
		(overlay_set_size, "$g_presentation_obj_12", pos1),#<- mtrch+ added
        ...
        (position_set_y, pos1, 615),#750),
        (overlay_set_position, "$g_presentation_obj_sliders_7", pos1),
        (position_set_y, pos1, 515),#600),
        (overlay_set_position, "$g_presentation_obj_sliders_8", pos1),
        (position_set_y, pos1, 415),#450),
        (overlay_set_position, "$g_presentation_obj_sliders_9", pos1),
        (position_set_y, pos1, 315),#300),
        (overlay_set_position, "$g_presentation_obj_sliders_10", pos1),
		#dplmc+ end pushed all items by 150, and incremented sliders by 1
		(position_set_y, pos1, 215),#150),#<- dplmc+ added
        (overlay_set_position, "$g_presentation_obj_sliders_11", pos1),#<- dplmc+ added
		(position_set_y, pos1, 115),#150),#<- mtrch+ added
        (overlay_set_position, "$g_presentation_obj_sliders_12", pos1),#<- mtrch+ added
		...
		#dplmc+ end incremented sliders by 1
		(overlay_set_size, "$g_presentation_obj_sliders_11", pos1),#<- dplmc+ added
		(overlay_set_size, "$g_presentation_obj_sliders_12", pos1),#<- dplmc+ added
        ]),
      (ti_on_presentation_run,
       [
        ]),
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        ...
        (else_try),
          ...
          (overlay_set_text, "$g_presentation_obj_sliders_10", ":value"),#dplmc+ incremented "sliders"
		...
		(else_try),
          ...
          (overlay_set_text, "$g_presentation_obj_sliders_11", ":value"),
		(else_try),
		  #mtrch+ new option: patriarchy
		  (eq, ":object", "$g_presentation_obj_sliders_6"),
          (faction_set_slot,  "fac_player_supporters_faction", mtrch_slot_faction_patriarchy, ":value"),
          (val_add, ":value", "str_mtrch_egalitarian"),
          (overlay_set_text, "$g_presentation_obj_sliders_12", ":value"),
		#Change variable associated with "Done" button.
        (else_try),
          (eq, ":object", "$g_presentation_obj_14"),#dplmc+ changed 10 to 12 #mtrch+ changed 12 to 14
