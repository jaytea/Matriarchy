...
# matriarchy begin
     (party_get_slot, ":female_volunteer_troop", "$current_town", slot_center_female_volunteer_troop_type),
     (party_get_slot, ":male_volunteer_amount", "$current_town", slot_center_volunteer_troop_amount),
     (party_get_slot, ":female_volunteer_amount", "$current_town", slot_center_female_volunteer_troop_amount),
     (val_max, ":male_volunteer_amount", 0),
     (val_max, ":female_volunteer_amount", 0),
     (store_add, ":volunteer_amount", ":male_volunteer_amount", ":female_volunteer_amount"),
#matriarchy end
     ...
     (try_end),
# matriarchy begin
     (val_min, ":male_volunteer_amount", ":volunteer_amount"),
     (val_min, ":female_volunteer_amount", ":volunteer_amount"),
     (assign, reg8, ":female_volunteer_amount"),
     (assign, reg9, ":male_volunteer_amount"),
# matriarchy end
     (try_begin),
     ...
     (else_try),
# matriarchy begin
       (eq, ":female_volunteer_amount", 0),
       (store_mul, reg6, ":male_volunteer_amount", 10),#10 denars per man
       (str_store_troop_name_by_count, s3, ":volunteer_troop", ":male_volunteer_amount"),
# matriarchy end
       (try_begin),
         (eq, reg5, 1),
...
# matriarchy begin
     (else_try),
       (eq, ":male_volunteer_amount", 0),
       (store_mul, reg6, ":female_volunteer_amount", 10),#10 denars per man
       (str_store_troop_name_by_count, s3, ":female_volunteer_troop", ":female_volunteer_amount"),
       (try_begin),
         (eq, reg5, 1),
         (str_store_string, s18, "@One {s3} volunteers to follow you."),
       (else_try),
       ...
       (set_background_mesh, "mesh_pic_recruits"),
     (else_try),
       (store_add, reg6, ":male_volunteer_amount", ":female_volunteer_amount"),#10 denars per man
       (val_mul, reg6, 10),
       (store_mul, reg10, ":male_volunteer_amount", 10),#10 denars per man
       (store_mul, reg11, ":female_volunteer_amount", 10),#10 denars per man
       (str_store_troop_name_by_count, s3, ":female_volunteer_troop", ":volunteer_amount"),
       (str_store_troop_name_by_count, s4, ":volunteer_troop", ":volunteer_amount"),
       (try_begin),
         (eq, reg5, 1),
         (str_store_string, s18, "@One {s3} and one {s4} volunteer to follow you."),
       (else_try),
         (str_store_string, s18, "@{reg8} {s3} and {reg9} {s4} volunteer to follow you."),
       (try_end),
       (set_background_mesh, "mesh_pic_recruits"),
# matriarchy end
     (try_end),
    ...
    [
      ...
      [
        ...
        (party_set_slot, "$current_town", slot_center_female_volunteer_troop_amount, -1), # mtrch+
        (jump_to_menu,"mnu_village"),
      ]),
      ...
      [
        (eq, reg7, 0),
        (gt, reg5, 0),
        (eq, reg8, 0), # mtrch+ no female volunteers
      ],
...
# matriarchy begin
      ...
      [
        (eq, reg7, 0),
        (gt, reg5, 0),
        (eq, reg9, 0), # mtrch+ no male volunteers
      ],
      "Recruit them ({reg6} denars).",
      [
        (call_script, "script_village_recruit_female_volunteers_recruit"),
      ...
      "Recruit the women({reg11} denars).",
      [
        (call_script, "script_village_recruit_female_volunteers_recruit"),
...
##diplomacy end+
  ...
  (
    ...
    "As a lord of a fief you can now appoint a chamberlain who resides at you court for a weekly salary of 15 denars. He or she will handle all financial affairs like collecting and determining taxes, paying wages and managing your estate. In addition he or she supervises money transfers between kingdoms giving you more diplomatic options.",
    "none",
    [],
    [
	...
	#matriarchy begin
      ("mtrch_appoint_woman",[],"Appoint a prominent noblewoman from the area.",
       [
        (call_script, "script_mtrch_appoint_chamberlain"),
        (jump_to_menu, "mnu_mtrch_chamberlain_confirm"),
        ]),
	#matriarchy end
...
#matriarchy begin
  (
    "mtrch_chamberlain_confirm",0,
    "Your chamberlain can be found at your court. You should consult her if you want to give her any financial advice or you need greater amounts of money. You should always make sure that there is enough money in the treasury to pay for political affairs.",
    "none",
    [],
    [
      ("dplmc_continue",[],"Continue...",
...
#matriarchy end
  ...
  (
	...
	#matriarchy begin
      ("mtrch_appoint_woman",[],"Appoint a prominent noblewoman from the area.",
       [
        (call_script, "script_mtrch_appoint_constable"),
        (jump_to_menu, "mnu_mtrch_constable_confirm"),
        ]),
	#matriarchy end
...
#matriarchy begin
  (
    "mtrch_constable_confirm",0,
    "Your constable can be found at your court. You should consult her if you want to recruit new troops or get detailed information about your standing army.",
    "none",
    [],
    [
      ("dplmc_continue",[],"Continue...",
...
#matriarchy end
  ...
  (
    ...
    "As a lord of a fief you can now appoint a chancellor who resides at you court for a weekly salary of 20 denars. He or she will be the keeper of your seal and conduct the correspondence between you and other important persons.",
    "none",
    [],
    [
	...
	#matriarchy begin
      ("mtrch_appoint_woman",[],"Appoint a prominent noblewoman from the area.",
       [
        (call_script, "script_mtrch_appoint_chancellor"),
        (jump_to_menu, "mnu_mtrch_chancellor_confirm"),
        ]),
	#matriarchy end
...
#matriarchy begin
  (
    "mtrch_chancellor_confirm",0,
    "Your chancellor can be found at your court. You should consult her if you want to send messages or gifts.",
    "none",
    [],
    [
      ("dplmc_continue",[],"Continue...",
