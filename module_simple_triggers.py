...
# matriarchy begin
		(faction_get_slot, reg0, "$players_kingdom", mtrch_slot_faction_patriarchy),
		(faction_set_slot, "fac_player_supporters_faction", mtrch_slot_faction_patriarchy,  reg0),
# matriarchy end
	(try_end),
	##nested diplomacy end+
  (try_for_range, ":kingdom", kingdoms_begin, kingdoms_end),
    ...
    (faction_get_slot, ":mercantilism", ":kingdom", dplmc_slot_faction_mercantilism),
	 ##nested diplomacy end+
# matriarchy begin
    (faction_get_slot, ":patriarchy", ":kingdom", mtrch_slot_faction_patriarchy),
# matriarchy end
    ...
    (try_begin),
      ...
      (display_message, "@{!}DEBUG - mercantilism {reg1}"),
		##nested diplomacy end+
# matriarchy begin
      (assign, reg1, ":patriarchy"),
      (display_message, "@{!}DEBUG - patriarchy {reg1}"),
# matriarchy end
    (try_end),
...
# matriarchy begin
        (else_try),
          (eq, ":random", 6),
          (val_add, ":patriarchy", ":change"),
			 (val_clamp, ":patriarchy", -3, 4),#-3 min, +3 max
          (faction_set_slot, ":kingdom", mtrch_slot_faction_patriarchy, ":patriarchy"),
# matriarchy end
        (try_end),
      (try_end),
...
# matriarchy begin
   # reset the knighting candidates once a week
   (24*7,
   [
       (try_begin),
         (eq, "$g_mtrch_knighting_candidate", -1),
         (assign, "$g_mtrch_knighting_candidate", 0),
       (try_end),
    ]),
# matriarchy end
]
